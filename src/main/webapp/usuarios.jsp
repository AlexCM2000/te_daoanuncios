...
<html>
    ...
    <body>
        ...
        <p><a class="btn btn-outline-primary btn-lg" href="UsuarioController?action=add">Nuevo</a></p>
        <table class="table table-striped table-hover" >
            ...
            <c:forEach var="item" items="${usuarios}">
                <tr>
                    ...
                    <td><a class="btn btn-danger" href="UsuarioController?action=delete&id=${item.id}"
